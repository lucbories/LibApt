...
/**
 * @brief		Pivot axis class
 * @param[in]	arg_name			pivot axis name (string)
 * @param[in]	arg_label			pivot axis label (string)
 * @param[in]	arg_ordered_groups	ordered groups (object of class LibaptField)
 */
