<?php
/**
 * @file        class_ldap_authentication.php
 * @brief       Authentication adapter based on a ldap server
 * @details     ...
...
final class ModelAuthentication extends AbstractAuthentication
{
	...
	// CONSTRUCTOR
	public function __construct($arg_connect_url, $arg_connect_user, $arg_connect_passwd)
	{
