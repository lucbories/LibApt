...
abstract class AbstractQuery
{
	...
	static public $TYPE_INSERT_IGNORE	= "INSERT IGNORE";
	static public $TYPE_REPLACE			= "REPLACE";
	static public $TYPE_SELECT			= "SELECT";
	static public $TYPE_SELECT_DISTINCT	= "SELECT DISTINCT";
	static public $TYPE_SELECT_DISTINCT_ONE	= "SELECT DISTINCT_ONE";
	static public $TYPE_SELECT_COUNT	= "SELECT COUNT";
	static public $TYPE_UPDATE			= "UPDATE";
	static public $TYPE_DELETE			= "DELETE";
	static public $TYPE_DELETE_ALL		= "DELETE_ALL";
	
	static public $OPTION_CREATE_TYPES;
	static public $OPTION_READ_TYPES;
	static public $OPTION_UPDATE_TYPES;
	static public $OPTION_DELETE_TYPES;
	
	static public $OPTION_TYPE				= "type";
	static public $OPTION_FIELDS			= "fields";
	// static public $OPTION_JOINS				= "joins";
	...
	// CONSTRUCTOR
	public function __construct($arg_fields_set, $arg_type)
	{
	...
	{
		$this->is_compiled  = false;
		if ($arg_field instanceof AbstractField)
		{
...
//		TRACE::trace_var($context, "compiled_sql", $this->compiled_sql, true);
...
//			TRACE::trace_var($context, "arg_fields and arg_values are arrays");
		}
		if ( ! is_array($arg_fields) and ! is_array($arg_values) )
		{
...
//			TRACE::trace_var($context, "arg_fields and arg_values are not arrays");
		}
		
//		TRACE::trace_var($context, "fields.count", count($fields));
//		TRACE::trace_var($context, "values.count", count($values));
//		TRACE::trace_var($context, "values", $values);
...
//			TRACE::trace_var($context, "filter added at $index = ($field_name, $value)");
			$index++;
		}
	...
	public function dump()
	{
		...
		$buffer_str .= "(fields_set.fields_count=".count( $this->fields_set->getFields() ).")<BR>\n";
