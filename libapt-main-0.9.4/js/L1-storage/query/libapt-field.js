...
LibaptField.create = function(arg_settings)
{
	...
	trace_enter(context, '', LIBAPT_FIELD_TRACE);
	...
	{
		trace_error(context, 'model name definition is not valid', LIBAPT_FIELD_TRACE);
		return null;
	}
	if ( Libapt.is_empty_str_or_null(ext_settings.model_name) )
	{
		trace_error(context, 'model model_name definition is not valid', LIBAPT_FIELD_TRACE);
		return null;
	}
	if ( Libapt.is_empty_str_or_null(ext_settings.source) || (ext_settings.source != 'model' && ext_settings.source != 'inline') )
	{
		trace_error(context, 'model source definition is not valid', LIBAPT_FIELD_TRACE);
		return null;
	}
	if ( Libapt.is_empty_str_or_null(ext_settings.value_type) )
	{
		trace_error(context, 'model value_type definition is not valid', LIBAPT_FIELD_TRACE);
		return null;
	}
	...
	trace_leave(context, '', LIBAPT_FIELD_TRACE);
	return field_obj;
}
