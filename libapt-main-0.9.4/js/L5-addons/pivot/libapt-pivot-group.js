...
/**
 * @brief		Pivot group class
 * @param[in]	arg_name			pivot group name (string)
 * @param[in]	arg_field			field (object of class LibaptField)
 * @param[in]	arg_label			pivot group label (string)
 */
