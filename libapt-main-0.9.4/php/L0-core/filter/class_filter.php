...
class Filter
{
	...
	static public $OPERATORS = array(
		// STRING OPERATORS
		"equals", "begins with", "contains", "ends with", "min length", "max length", "length between", "in",
		// NUMBER OPERATORS
		"gt", "ge", "lt", "le", "between"
		);
	...
	{
		// BINARY OPERATORS
		if ($arg_operator == "equals" or $arg_operator == "length between"
			or $arg_operator == "gt" or $arg_operator == "ge" or $arg_operator == "lt" or $arg_operator == "le" or $arg_operator == "between")
		{
			return 2;
		}
