...
abstract class AbstractPageLayoutView extends AbstractTemplateViewImpl
{
	...
	public function htmlBegin()
	{
		...
		// IE < IE9 compatibility
		$prefix_url		= LIBAPT_FRAMEWORK_STATIC_URL."/externals/";
		$headers .= "
			<!--[if lt IE 9]>
				<meta http-equiv='X-UA-Compatible' content='IE=EmulateIE7' />
				<script src='$prefix_url/html5shiv/html5shiv.js'></script>
				<script src='$prefix_url/respond/respond.min.js'></script>
			<![endif]-->";
