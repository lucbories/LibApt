...
abstract class AbstractModel extends AbstractControlledImpl
{
	...
	abstract public function readCount($arg_fields, $arg_filters, $arg_orders, $arg_options);
	abstract public function readCountWithSlice($arg_fields, $arg_filters, $arg_orders, $arg_slice_offset, $arg_slice_length, $arg_options);
