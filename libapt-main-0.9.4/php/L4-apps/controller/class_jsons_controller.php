...
class JsonsController extends AbstractCrudController
{
	...
	protected function doModelCreate($arg_model, $arg_url_parameters, $arg_action_name = null)
	{
		...
		TRACE::trace_var($context, "fields_list", $fields_values, self::$TRACE_JSON_CONTROLLER);
		TRACE::trace_var($context, "fields_values", $fields_list, self::$TRACE_JSON_CONTROLLER);
		
		// RUN QUERY
		$result = $arg_model->create($fields_list, $fields_values, null);
		
		return TRACE::leave($context, $result, "Execution of CREATE query failed", false, self::$TRACE_JSON_CONTROLLER);
	}
	...
	protected function doModelRead($arg_model, $arg_url_parameters, $arg_action_name = null)
	{
		...
		TRACE::trace_var($context, "drecords_count", $records_count, self::$TRACE_JSON_CONTROLLER);
