<?php
/**
 * @version		$Id: class_xls_model_view.php 2012-07-22 LBO $
 * @package		A PHP TOOLKIT (APT) Library
 * @subpackage	libapt-main/L3-views
 * @copyright	Copyright (C) 2011 Luc BORIES All rights reserved.
 * @license		Apache License Version 2.0, January 2004; see LICENSE.txt or http://www.apache.org/licenses/
 */
class XlsModelView extends AbstractModelViewImpl
{
	// ATTRIBUTES
	...
	public function console()
	{
		...
		echo XlsExport::export($fields, $datas_records);
	}
	...
	public function htmlSelf()
	{
		...
		XlsExport::htmlDownload($fields, $datas_records);
	}
}
?>