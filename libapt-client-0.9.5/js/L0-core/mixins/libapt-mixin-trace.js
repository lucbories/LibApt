...
var LibaptMixinTrace =
{
	...
	leave_or_error: function(arg_context, arg_ok_msg, arg_ko_msg, arg_bool_result)
	{
		...
		{
			Libapt.log_unindent();
			Libapt.trace_error(this.class_name + '.' + arg_context + '[' + this.name + ']', arg_ko_msg, this.trace);
		}
	},
	...
	error: function(arg_context, arg_msg)
	{
		if (this.trace)
		{
			Libapt.trace_error(this.class_name + '.' + arg_context + '[' + this.name + ']', arg_msg, this.trace);
		}
	},
	...
	value: function(arg_context, arg_name, arg_value)
	{
		if (this.trace)
		{
			Libapt.trace_var(this.class_name + '.' + arg_context + '[' + this.name + ']', arg_name, Libapt.get_value_str(arg_value), this.trace);
		}
	},
