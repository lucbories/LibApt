...
{
	var levels = ['log','info','warn','error','assert','dir','clear','profile','profileEnd'];
	for(levels_index in levels)
	{
		var method = levels[levels_index];
		alert('method=' + method);
		console[method].prototype.bind(console);
    }
}*/
  ...
  window.log = function () {
    ...
    // IE7 and lower, and other old browsers
      ...
      if (!document.getElementById('firebug-lite')) {
        ...
        script.src = APT_LIB_URL + '/js/L0-core/external/firebug-lite.js';
