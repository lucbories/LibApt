/**
 * @file        libapt-mixin-editor-integer.js
 * @desc        Mixin of editor view for integer values
 * @see			libapt-view.js
 * @group       LIBAPT_VIEWS
 * @date        2013-07-23
 * @version		0.9.x
...
/**
 * @mixin				LibaptMixinEditorInteger
 * @public
 * @desc				Mixin of editor view for integer values
 */
var LibaptMixinEditorInteger =
{
	/**
	 * @memberof			LibaptMixinEditorInteger
	 * @public
	...
	set_editor_values: function(arg_values)
	{
		...
		{
			self.content_jqo.val( Libapt.to_integer(arg_values) );
		}
	...
	get_editor_values: function(arg_values)
	{
		...
		if ( ! Libapt.is_null(self.content_jqo) /*&& self.content_jqo.tag_name == 'INPUT'*/)
		{
			value = Libapt.to_integer( self.content_jqo.val() );
		}
