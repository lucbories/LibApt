<?php
/**
 * @version		$Id: class_mysqli_sql_model.php 2012-01-15 LBO $
 * @package		A PHP TOOLKIT (APT) Library
 * @subpackage	libapt-main/model
 * @copyright	Copyright (C) 2011 Luc BORIES All rights reserved.
 * @license		Apache License Version 2.0, January 2004; see LICENSE.txt or http://www.apache.org/licenses/
 */
class MySQLiModel extends AbstractSQLModelImpl
{
	// ATTRIBUTES
	...
	public function __construct($arg_unique_name, $arg_connection_name)
	{
		...
		$this->storage_engine = new MySQLiStorage($arg_unique_name, $this->getFieldsSet(), $this->getConnection());
	}
