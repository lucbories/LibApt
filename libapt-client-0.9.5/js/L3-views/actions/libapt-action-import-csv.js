...
/**
 * @public
 * @class					LibaptLibaptActionImportCSV
 * @desc					CSV file import action class (not yet finished)
...
function LibaptActionImportCSV(arg_name, arg_model_view, arg_options)
{
	...
	/**
	 * @public
	 * @memberof			LibaptActionImportCSV
	 * @desc				Do the action
...
Libapt.register_class(LibaptActionImportCSV, ['LibaptAction'], 'Luc BORIES', '2013-08-21', 'Action to import datas from a CSV file.');
