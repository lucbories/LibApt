 ...
 * @brief       Pivot axis position class
 * @details     ...
...
/**
 * @brief		Pivot axis position class
 * @param[in]	arg_axis_obj					pivot axis object (LibaptPivotAxis)
 * @param[in]	arg_ordered_members_indexes		pivot axis ordered position members indexs (array of integers)
 * @param[in]	arg_ordered_members_values		pivot axis ordered position members (array of strings)
 */
